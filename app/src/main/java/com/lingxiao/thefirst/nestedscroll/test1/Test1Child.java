...
public class Test1Child extends LinearLayout implements NestedScrollingChild {
    ...
    public Test1Child(Context context) {
        this(context,null);
    }

    public Test1Child(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
