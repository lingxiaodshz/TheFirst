package com.lingxiao.thefirst.nestedscroll.test1;
...
public class Test1Parent extends LinearLayout implements NestedScrollingParent {
    NestedScrollingParentHelper nsp;
    ImageView iv;
    Test1Child nsc;
    int ivHeight;

    public Test1Parent(Context context) {
        this(context,null);
    }

    public Test1Parent(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
        ...
        if(target instanceof Test1Child){
            return true;
        }
